...
<body class="col-12">
    ...
    if (isset($_POST['nomeJogo']) && isset($_POST['categoria']) && !empty(trim($_POST['nomeJogo'])) && !empty(trim($_POST['categoria']))) {
    ...
    } elseif (isset($_GET['nomeJogo'])  && !empty(trim($_GET['nomeJogo']))) {
        require '../../database/banco.php';
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="excluirJogo.php" method="get">
                        <input type="hidden" name="nomeJogo" value="<?php echo $nomeJogo; ?>">
                        <button class="btn btn-primary" data-bs-toggle="modal">Excluir</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="adicionarComentario" aria-hidden="true" aria-labelledby="divAdicionarComentario" tabindex="-1">
        <form action="../comentarios/adicionarComentario.php" method="get">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="disabledTextInput" class="form-control" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $email; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Cometário</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="conteudo" rows="3"></textarea>
                        </div>
                        <div class="mb-3 row">
                            <label for="staticEmail" class="col-sm-1 col-form-label">Jogo:</label>
                            <div class="col-sm-5">
                                <input type="text" readonly class="form-control-plaintext" id="staticEmail" name="jogo" value="<?php echo $nomeJogo; ?>">
                            </div>
                        </div>
    ...
    if (isset($_POST['nomeJogo']) && isset($_POST['categoria'])) {
        require '../../database/banco.php';
                    ...
                    <div class="modal fade" id="modalEditar' . $comentario['idComentario'] . '" aria-hidden="true" aria-labelledby="EditarComentario' . $comentario['idComentario'] . '" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="row g-3 needs-validation" action="...php" novalidate>
                                        <div class="input-group has-validation">
                                            <label for="novoComentario' . $comentario['idComentario'] . '" class="form-label">Email</label>
                                            <div class="input-group">
                                            <input type="text" class="form-control" id="novoComentario' . $comentario['idComentario'] . '" aria-describedby="inputGroupPrepend3" name="novoConteudo" value="' . $comentario['comentarioConta'] . '">
                                            </div>
                                            <label for="novoComentario' . $comentario['idComentario'] . '" class="form-label">Comentário:</label>
                                            <div class="input-group">
                                            <input type="text" class="form-control" id="novoComentario' . $comentario['idComentario'] . '" aria-describedby="inputGroupPrepend3" name="novoConteudo" value="' . $comentario['conteudo'] . '" required>
                                            </div>
                                            <label for="novoComentario' . $comentario['idComentario'] . '" class="form-label">Jogo:</label>
                                            <div class="input-group">
                                            <input type="text" class="form-control" id="novoComentario' . $comentario['idComentario'] . '" aria-describedby="inputGroupPrepend3" name="novoConteudo" value="' . $comentario['jogoComentado'] . '">
                                            </div>
